...
template<> PAPERZD_API UScriptStruct* StaticStruct<FPaperZDAnimNode_Sink>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_Sink_h_Statics::ScriptStructInfo[] = {
		{ FPaperZDAnimNode_Sink::StaticStruct, Z_Construct_UScriptStruct_FPaperZDAnimNode_Sink_Statics::NewStructOps, TEXT("PaperZDAnimNode_Sink"), &Z_Registration_Info_UScriptStruct_PaperZDAnimNode_Sink, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPaperZDAnimNode_Sink), 2555866731U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_Sink_h_3863915806(TEXT("/Script/PaperZD"),
		nullptr, 0,
