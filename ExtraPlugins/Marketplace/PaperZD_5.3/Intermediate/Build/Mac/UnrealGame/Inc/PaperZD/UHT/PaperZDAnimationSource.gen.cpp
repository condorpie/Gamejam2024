...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UPaperZDAnimationSource_Statics::NewProp_SupportedAnimSequenceClass = { "SupportedAnimSequenceClass", nullptr, (EPropertyFlags)0x0024080000020001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPaperZDAnimationSource, SupportedAnimSequenceClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UPaperZDAnimSequence_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPaperZDAnimationSource_Statics::NewProp_SupportedAnimSequenceClass_MetaData), Z_Construct_UClass_UPaperZDAnimationSource_Statics::NewProp_SupportedAnimSequenceClass_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPaperZDAnimationSource_Statics::NewProp_bSupportsAnimationLayers = { "bSupportsAnimationLayers", nullptr, (EPropertyFlags)0x0020080000020001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPaperZDAnimationSource), &Z_Construct_UClass_UPaperZDAnimationSource_Statics::NewProp_bSupportsAnimationLayers_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPaperZDAnimationSource_Statics::NewProp_bSupportsAnimationLayers_MetaData), Z_Construct_UClass_UPaperZDAnimationSource_Statics::NewProp_bSupportsAnimationLayers_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PaperZD_Source_PaperZD_Public_AnimSequences_Sources_PaperZDAnimationSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPaperZDAnimationSource, UPaperZDAnimationSource::StaticClass, TEXT("UPaperZDAnimationSource"), &Z_Registration_Info_UClass_UPaperZDAnimationSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPaperZDAnimationSource), 771609590U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PaperZD_Source_PaperZD_Public_AnimSequences_Sources_PaperZDAnimationSource_h_3210151575(TEXT("/Script/PaperZD"),
