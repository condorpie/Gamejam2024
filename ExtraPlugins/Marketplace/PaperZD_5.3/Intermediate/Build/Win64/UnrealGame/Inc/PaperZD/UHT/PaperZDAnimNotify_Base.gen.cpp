...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPaperZDAnimNotify_Base_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPaperZDAnimNotify_Base_GetDisplayName, "GetDisplayName" }, // 829756971
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPaperZDAnimNotify_Base_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPaperZDAnimNotify_Base_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPaperZDAnimNotify_Base, Time), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPaperZDAnimNotify_Base_Statics::NewProp_Time_MetaData), Z_Construct_UClass_UPaperZDAnimNotify_Base_Statics::NewProp_Time_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPaperZDAnimNotify_Base_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPaperZDAnimNotify_Base, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPaperZDAnimNotify_Base_Statics::NewProp_Name_MetaData), Z_Construct_UClass_UPaperZDAnimNotify_Base_Statics::NewProp_Name_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UPaperZDAnimNotify_Base_Statics::NewProp_TrackIndex = { "TrackIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPaperZDAnimNotify_Base, TrackIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPaperZDAnimNotify_Base_Statics::NewProp_TrackIndex_MetaData), Z_Construct_UClass_UPaperZDAnimNotify_Base_Statics::NewProp_TrackIndex_MetaData) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PaperZD_Source_PaperZD_Public_Notifies_PaperZDAnimNotify_Base_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPaperZDAnimNotify_Base, UPaperZDAnimNotify_Base::StaticClass, TEXT("UPaperZDAnimNotify_Base"), &Z_Registration_Info_UClass_UPaperZDAnimNotify_Base, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPaperZDAnimNotify_Base), 2361601344U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PaperZD_Source_PaperZD_Public_Notifies_PaperZDAnimNotify_Base_h_2759981441(TEXT("/Script/PaperZD"),
