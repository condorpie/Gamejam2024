...
#include "../Private/Graphs/PaperZDStateMachineSchema.h"
...
template<> PAPERZDEDITOR_API UScriptStruct* StaticStruct<FPaperZDStateMachineSchemaAction_NewComment>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PaperZD_Source_PaperZDEditor_Private_Graphs_PaperZDStateMachineSchema_h_Statics::ScriptStructInfo[] = {
		{ FPaperZDStateMachineSchemaAction_NewNode::StaticStruct, Z_Construct_UScriptStruct_FPaperZDStateMachineSchemaAction_NewNode_Statics::NewStructOps, TEXT("PaperZDStateMachineSchemaAction_NewNode"), &Z_Registration_Info_UScriptStruct_PaperZDStateMachineSchemaAction_NewNode, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPaperZDStateMachineSchemaAction_NewNode), 1879359708U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PaperZD_Source_PaperZDEditor_Private_Graphs_PaperZDStateMachineSchema_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPaperZDStateMachineSchema, UPaperZDStateMachineSchema::StaticClass, TEXT("UPaperZDStateMachineSchema"), &Z_Registration_Info_UClass_UPaperZDStateMachineSchema, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPaperZDStateMachineSchema), 3492346079U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_PaperZD_Source_PaperZDEditor_Private_Graphs_PaperZDStateMachineSchema_h_3627900736(TEXT("/Script/PaperZDEditor"),
